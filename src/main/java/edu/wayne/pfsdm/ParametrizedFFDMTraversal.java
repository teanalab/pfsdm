...
import edu.wayne.models.FieldedFullDependenceTraversal;
 ...
 */
public class ParametrizedFFDMTraversal extends FieldedFullDependenceTraversal {
    ...
    public ParametrizedFFDMTraversal(Retrieval retrieval) {
        super(retrieval);
    ...
    public Node afterNode(Node original, Parameters qp) throws Exception {
        if (original.getOperator().equals("pffdm")) {
    ...
    protected BigramNodes getBigramNodes(Node original, Parameters qp, java.util.List<Node> seq, int uwWidth) throws Exception {
